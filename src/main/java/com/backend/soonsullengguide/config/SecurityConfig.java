    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/api/google-login", "/api/refresh-token","/api/check-nickname", "/api/reviews", "/static/images/**", "/static/uploads/**", "/home/ec2-user/static/images/", "/images/**").permitAll()
